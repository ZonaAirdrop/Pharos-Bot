        ...
        while True:
            try:
                ...
                if option in [1, 2, 3]:
                    ...
                    print(f"{Fore.RED + Style.BRIGHT}Please enter either 1, 2, 3.{Style.RESET_ALL}")
            except ValueError:
                print(f"{Fore.RED + Style.BRIGHT}Invalid input. Enter a number (1, 2, 3,).{Style.RESET_ALL}")
