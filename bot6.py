...
class PharosTestnet:
    ...
    def signal_handler(self, signum, frame):
        ...
        print(f"\n{Fore.YELLOW}📢 Graceful shutdown requested...")
        print(f"{Fore.GREEN}✅ Bot stopped safely")
        sys.exit(0)
    ...
    async def run_24h_automation(self, config):
        ...
        self.log(f"⏰ Duration: 24 hours with digital countdown timer")
        ...
        while not shutdown_requested:
            try:
                ...
                for i in range(3600):  # 1 hour = 3600 seconds
                    ...
                    if i % 60 == 0:  # Update countdown every minute
                        ...
                        print(f"\r{Fore.CYAN}⏰ 24H Timer: {remaining_time} | Next cycle: {hours:02d}:{minutes:02d}:{seconds:02d}", end="", flush=True)
